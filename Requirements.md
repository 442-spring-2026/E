...
S4. An button to apply filters is displayed.
...
S7. The activity list updates to show activities with duration less than or equal to the selected time.
...
S16. An button to add the activity to the Daily Plan is displayed.
